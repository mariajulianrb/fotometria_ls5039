...
ARQUIVO = '/home/maju/Downloads/dados/astronometry/ls5039_R_wcs.fits'
FWHM = 7.51845
RAIO_AP = 1.5 * FWHM
...
THRESHOLD_SIGMA = 10 
MIN_SNR = 5.0          
MAX_REGIOES_DS9 = 500  # Limite de anéis a serem desenhados no DS9
...
df.to_csv('fotometria_final_R.csv', index=False)
